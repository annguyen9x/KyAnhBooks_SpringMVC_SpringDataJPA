...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th8 16, 2020 lúc 05:22 AM
...
CREATE TABLE `nhapsach` (
  `maNS` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `maNVKho` int NOT NULL,
...
ALTER TABLE `chitiethoadon`
  ...
  ADD KEY `FK__ChiTietHo__MaSac__286302EC` (`MaSach`);
...
ALTER TABLE `hoadon`
  ...
  ADD KEY `FK__HoaDon__MaNV_NV` (`MaNVGiao`),
  ADD KEY `FK__HoaDon__MaKH__KH` (`MaKH`);
...
ALTER TABLE `nhanvien`
  ...
  ADD UNIQUE KEY `UQ__NhanVien__1F0318769AFB27F6` (`DienThoai`),
  ADD UNIQUE KEY `UQ__NhanVien__A9D10534A1AEC144` (`Email`);
...
ALTER TABLE `sach`
  ...
  ADD KEY `idx_sach` (`MaSach`,`TenSach`),
  ADD KEY `FK__Sach__MaLoaiSach__1BFD2C07` (`MaLoaiSach`);
...
--
ALTER TABLE `hoadon`
  MODIFY `SoHD` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10000009;
...
--
ALTER TABLE `nhanvien`
  MODIFY `MaNV` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1006;
...
--
ALTER TABLE `chitiethoadon`
  ADD CONSTRAINT `FK__ChiTietHo__MaSac__286302EC` FOREIGN KEY (`MaSach`) REFERENCES `sach` (`MaSach`) ON UPDATE CASCADE,
  ADD CONSTRAINT `FK__ChiTietHoa__SoHD__276EDEB3` FOREIGN KEY (`SoHD`) REFERENCES `hoadon` (`SoHD`) ON UPDATE CASCADE;
...
--
ALTER TABLE `sach`
  ADD CONSTRAINT `FK__Sach__MaLoaiSach__1BFD2C07` FOREIGN KEY (`MaLoaiSach`) REFERENCES `loaisach` (`MaLoaiSach`) ON UPDATE CASCADE;
COMMIT;
