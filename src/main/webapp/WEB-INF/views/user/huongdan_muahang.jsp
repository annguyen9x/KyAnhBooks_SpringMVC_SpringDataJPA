...
<!-- start my js -->
	...
	<script src="${kyanhbooksRootPath}${userStaticRootPath}js/formValidation.js" type="text/javascript" charset="utf-8"></script>
<!-- end my js -->
										...
										<div class="col-md-12 col-sm-12 col-xs-12 group-left-list-sp">
											...
											<div>
												...
												<div style="width: 40%; height: 100%; float: left;">
													<img src="${kyanhbooksRootPath}${userStaticRootPath}img/tintuc/muahang.jpg" alt="anh huong dan mua hang" style="width: 100%; vertical-align: top">
												</div>
											</div>
											<p style="clear:both;">
												<strong>
