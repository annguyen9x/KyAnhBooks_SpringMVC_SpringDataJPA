			                    ...
			                    <div class="col-sx-12">
									...
									%>
										<div class="alert alert-success">
											<strong>Đăng nhập thành công.</strong> Vui lòng vào mục <a href="${kyanhbooksRootPath}<%=Constant.Path.USER_CONTROLLER_KHACH_HANG_HIENTHI_CAPNHAT_TAIKHOAN%>">cập nhật tài khoản</a> để đặt lại mật khẩu !
										</div>
									<%
				                    	...
				                    	<div class="col-md-6 col-md-offset-3">
											<form method="post" action="${kyanhbooksRootPath}<%=Constant.Path.USER_CONTROLLER_KHACH_HANG_LAY_MA_XN_EMAIL%>" class="form-horizontal">
									            ...
									            <div class="form-group">
									            		...
									            		<a href="${kyanhbooksRootPath}<%=Constant.Path.USER_CONTROLLER_KHACH_HANG_HIENTHI_DANGNHAP%>">Quay lại đăng nhập</a>
									            		<%
									          ...
									          <form method="post" action="${kyanhbooksRootPath}<%=Constant.Path.USER_CONTROLLER_XAC_NHAN_EMALI%>" class="form-horizontal">
									            <div class="form-group">
								            		...
								            		<input type="hidden" class="form-control" id="emailHidden" name="emailHidden" value="<%if(email != null){out.print(email);} %>">
									            </div>
									            <%
